...
int main (int argc, char *argv[])
{
  ...
  std::shared_ptr<OB::ConvexPolytope> pyramid5 = std::make_shared<OB::ConvexPolytope>(create_pyramid_polytope(5, 0.8, 0.8));
  ...
  OB::WorldConvexPolytope wcp0{"prism6", pyramid5};
  t = OB::Translation(0, 4 ,0) * OB::AngleAxis(OB::PI * 0.02, OB::Vector::UnitX().normalized());
  wcp0.set_pose(t);
  ...
  t = OB::Translation(1, 3 ,0) * OB::AngleAxis(OB::PI, OB::Vector::UnitZ().normalized())
      * OB::AngleAxis(OB::PI, OB::Vector::UnitY().normalized());
