// Copied from here: https://bitbucket.org/volkanozyilmaz/logcpp/src/master/log.h
...
#define FILELOG_MAX_LEVEL OB::ldebug4
#endif

#define FILE_LOG(level) \
    if (level > FILELOG_MAX_LEVEL) ;\
    else if (level > OB::FILELog::ReportingLevel() || !OB::Output2FILE::Stream()) ; \
    else OB::FILELog().Get(level)
