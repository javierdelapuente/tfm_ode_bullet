...
data = pd.read_csv("./comparativa5.csv", header=None, sep=";")
print(data.head())
...
### ahora energia
fig, axs = plt.subplots(1)
fig.suptitle('Energía')
axs.plot(dataode[COLUMN_GLOBAL_TIME], dataode[COLUMN_BODY_KINETIC_ENERGY], 'b--', label='ode')
axs.plot(databullet[COLUMN_GLOBAL_TIME], databullet[COLUMN_BODY_KINETIC_ENERGY], 'r', label='bullet')
axs.set_ylabel("Energía cinética")
axs.legend()
